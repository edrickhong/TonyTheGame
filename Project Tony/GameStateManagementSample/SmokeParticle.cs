...
namespace GameStateManagementSample
{
    public class SmokeParticles
    {
        ...
        public SmokeParticles(Texture2D texture, Vector2 position, Vector2 velocity, float angle, float angularVelocity, Color color, float size, int ttl)
        {
        ...
        public SmokeParticles(Texture2D texture, Vector2 position, Vector2 velocity, float angle, float angularVelocity, Color color, float size, int ttl, int fadein, double fadeDe)
        {
