...
namespace GameStateManagementSample
{
    public class BloodParticles
    {
        ...
        public bool addSplatter=false;
        Texture2D rec;
public BloodParticles(Texture2D texture, Vector2 position, Vector2 velocity,float angle, float angularVelocity, Color color, float size, int ttl,Texture2D rec){
...
public void Draw(SpriteBatch spriteBatch)
{
    ...
    //spriteBatch.Draw(rec,col,Color.White);
}
